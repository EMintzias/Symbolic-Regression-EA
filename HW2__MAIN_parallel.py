...
#%%
filename = 'Results_Bronze.txt/RS_date_Oct-21_17-49_5_tests_100_evals.pkl'
...
#  RUN RANDOM SEARCH
start = time.time()
function, mse_arr = Random_Search(10000,
                                  data=Bronze_data,
                                  max_depth=3,
                                  C_range=Y_range_Cu)
...
print(rslt_msg)
arr = np.arange(0, 101)
# Sample data or images (replace with your data)
...
check_diversity(Bronze_population)
